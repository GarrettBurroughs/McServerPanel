<template>
  <div id="creator">
    ...
    <div id="version">
      ...
      <button v-on:click="createFromVersion">
        Create!
      </button>
    </div>
    ...
    <div id="url">
      ...
      <button v-on:click="createFromUrl">
        Create!
      </button>
    </div>
    ...
    <div id="manual">
      ...
      A folder will be generated under <code>minecraft/{server name}</code>
      <br />
      <button v-on:click="createManual">
        Create!
      </button>
    </div>
  </div>
